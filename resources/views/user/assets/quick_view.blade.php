          ...
          <div class="modal-body product_view d-none">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-4">
                    <div class="">
                        <img src="{{ asset('storage/'.$product->thumbnail) }}" height="100%" width="100%">
                    </div>
                  </div>
                  <div class="col-lg-8 ">
                    <h3>{{ $product->p_title }}</h3>
                     ...
                     <p>Stock: @if($product->p_qty <  $product->p_alert_qty) <span class="badge badge-danger">Stock Out</span> @else <span class="badge badge-success">Stock Available</span> @endif </p>
                     <div class="">

                        <div class="">Price: {{ $setting->default_currency }}{{ $product->p_price }}</div>

                        <div class="" >
                            Price: <del class="text-danger">{{ $setting->default_currency }}{{ $product->p_price }}</del class="text-danger">
                     ...
                     <div class="order_info d-flex flex-row">
                        <form action="" method="post" id="add_cart_form">
                          ...
                          @if($product->p_discount_price==NULL)
                            ...
                            <div class="button_container">
                                <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                      @if($product->p_qty <  $product->p_alert_qty)
